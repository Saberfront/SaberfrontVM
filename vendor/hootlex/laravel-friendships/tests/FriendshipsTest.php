...
class FriendshipsTest extends TestCase
{
    ...
    public function it_returns_user_friends()
    {
        ...
        $this->containsOnlyInstancesOf(\Saberfront\User::class, $sender->getFriends());
    }
    ...
    public function it_returns_user_friends_of_friends()
    {
        ...
        $this->containsOnlyInstancesOf(\Saberfront\User::class, $sender->getFriendsOfFriends());
    }
    ...
    public function it_returns_user_mutual_friends()
    {
        ...
        $this->containsOnlyInstancesOf(\Saberfront\User::class, $sender->getMutualFriends($recipients[0]));
    }
    ...
    public function it_returns_user_mutual_friends_per_page()
    {
        ...
        $this->containsOnlyInstancesOf(\Saberfront\User::class, $sender->getMutualFriends($recipients[0], 2));
    }
